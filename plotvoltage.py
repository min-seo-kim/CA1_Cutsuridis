...
for mgconc in [0.0, 0.5, 1.0, 2.0]: #, 0.1, 0.5, 1.0, 1.5, 2.0, 5.0]:
...
spks1 = np.loadtxt("pyresults/mg_0.0_cellv_1.dat",skiprows=1)
spks2 = np.loadtxt("pyresults/mg_0.5_cellv_1.dat",skiprows=1)
spks3 = np.loadtxt("pyresults/mg_1.0_cellv_1.dat",skiprows=1)
spks4 = np.loadtxt("pyresults/mg_2.0_cellv_1.dat",skiprows=1)
plt.figure(figsize=(12,10))
plt.subplot(4,1,1)
plt.plot(spks1[:,0],spks1[:,1],'r',label='Mg = 0.0 mM')
plt.ylabel("Membrane Potential (mV)")
plt.ylim([-80, 15])
plt.title("Pattern Pyramidal Cell 1")
plt.legend(loc='upper right')
plt.subplot(4,1,2)
plt.plot(spks2[:,0],spks2[:,1],'g',label='Mg = 0.5 mM')
plt.ylabel("Membrane Potential (mV)")
plt.ylim([-80, 15])
plt.legend(loc='upper right')
plt.subplot(4,1,3)
plt.plot(spks3[:,0],spks3[:,1],'b',label='Mg = 1.0 mM')
plt.ylabel("Membrane Potential (mV)")
plt.ylim([-80, 15])
plt.legend(loc='upper right')
plt.subplot(4,1,4)
plt.plot(spks4[:,0],spks4[:,1],'k',label='Mg = 2.0 mM')
plt.xlabel("Time (ms)")
plt.ylabel("Membrane Potential (mV)")
plt.ylim([-80, 15])
plt.legend(loc='upper right')
